...
class Filtro extends Component {
    ...
    if (tecla == 32) {
      ...
      if (patron.test(tecla_final)) {
        ...
        if (e.fromCharCode != typeof undefined) {
          ...
          this.setState({
            textPopup: "El campo solo puede ser llenado con letras y números",
          });
          this.togglePopup();
          return false;
        }
  ...
  sacar() {
    var filtracion0 = this.state.cursos.filter(
      (curso) =>
      ...
      <div>
        ...
        <div className="carruPrincial">
          <div className="carruIzq">
            {this.estadoBotIzq ? (
              <button
                className="Bt-Flecha1"
                onClick={this.flechaIqzClickada}
              ></button>
            ) : null}
          </div>
          ...
          <div className="carruMedio">
                    ...
                    >
                      ...
                      >
                        <div className="linkCurso">
                            <h3 className="contendNomCurso">{curso.nombre}</h3>                  
            ...
            {this.numFiltrado === 0 ? (
              <div id="contenedorNoEnc">
                <h1>
                  {" "}
                  <img src={`/assets/imagenes/ImagenDeNoEncontrado.PNG`}></img>
          ...
          <div className="carruDere">
            {this.estadoBotDere ? (
              <button
                className="Bt-Flecha"
                onClick={this.flechaDereClickada}
              ></button>
            ) : null}
          </div>
        </div>
